        ...
        <form action="{{ route('events.update', $event) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                    class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500">{{ old('description', $event->description) }}</textarea>
            </div>
